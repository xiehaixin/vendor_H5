    ...
    <div class="snuff">
      <div class="list-box">
        ...
        <div class="bottom-box">
         ...
         <div class="btn">
           <i v-if="item.number > 0" @click="buyGoods(item, _screen(item))" class='iconfont icon-icon-shoppingcar3'></i>
           <i v-else style="color:#BCBCBB" class='iconfont icon-icon-shoppingcar3'></i>
           <!-- <button v-if="item.number > 0" @click="buyGoods(item, _screen(item))" :class="['theme_' + $store.state.styleColor]">购买</button>
           <button v-else style="background:#BCBCBB">购买</button> -->
         </div>
